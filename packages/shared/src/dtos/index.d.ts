...
export type OrgType = 'brokerage' | 'team' | 'transaction_coordination_company' | 'title_company' | 'escrow_company' | 'lender' | 'law_firm';
export type MembershipStatus = 'pending' | 'active' | 'rejected';
export type MemberRole = 'broker_admin' | 'agent' | 'transaction_coordinator';
...
export type TransactionStatus = 'draft' | 'active' | 'under_contract' | 'pending_close' | 'closed' | 'cancelled' | 'archived' | 'seller_response_rejected' | 'inspection_contingency_removed';
export type TransactionStage = 'intake' | 'contract' | 'disclosures' | 'inspection' | 'appraisal' | 'loan' | 'escrow' | 'closing' | 'post_close';
export type PartyRole = 'buyer' | 'seller' | 'buyer_agent' | 'seller_agent' | 'buyer_transaction_coordinator' | 'seller_transaction_coordinator' | 'lender' | 'loan_officer' | 'escrow_officer' | 'title_officer' | 'attorney' | 'inspector' | 'appraiser' | 'other';
...
export type VpStatus = 'scheduled' | 'reminder_sent' | 'waiting_for_form' | 'form_received' | 'validated' | 'ready_for_docusign' | 'sent_via_docusign' | 'fully_executed';
...
export type FinalTermKey = 'loan' | 'appraisal' | 'inspection' | 'insurance' | 'sellerDocumentReview' | 'titleReview' | 'hoaReview' | 'disclosuresDue' | 'emdInitialDeposit';
 ...
 */
export type FinalValueKey = 'purchasePrice' | 'offerDate' | 'closeOfEscrow' | 'possession' | 'sellerCreditToBuyer' | 'initialDeposit';
