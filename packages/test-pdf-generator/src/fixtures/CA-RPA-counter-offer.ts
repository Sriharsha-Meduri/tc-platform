...
const rpaData = {
  ...
  seller_acceptance: {
    ...
    seller_signature_date: { value: '6/8/2026', enabled: true },
    buyer_signature_date: { value: '6/8/2026', enabled: true },
  },
  signatures: {
...
const bcoBase = {
  ...
  expiration: {
    expiration_date: { value: null, enabled: false },
    expiration_time: { value: '5:00', enabled: true },
    expiration_time_period: { value: 'PM', enabled: true },
  },
  section_3_offer: {
    offeror_1_signature_date: { value: null, enabled: false },
    offeror_2_signature_date: { value: null, enabled: false },
...
const sco1 = {
  ...
  header: {
    ...
    date: { value: '2026-01-03', enabled: true },
  },
  offer_reference: {
    ...scoBase.offer_reference,
    referenced_form_code: { value: 'RPA', enabled: true },
    referenced_offer_date: { value: '6/8/2026', enabled: true },
    referenced_counter_offer_number: { value: null, enabled: false },
  },
  expiration: {
    ...scoBase.expiration,
    expiration_date: { value: '2026-01-06', enabled: true },
  },
  section_4_offer: {
    ...scoBase.section_4_offer,
    offeror_1_signature_date: { value: '2026-01-03', enabled: true },
    offeror_1_typed_name: { value: 'Jane Seller', enabled: true },
  },
  section_5_acceptance: {
    ...scoBase.section_5_acceptance,
    acceptor_1_signature_date: { value: '2026-01-04', enabled: true },
  ...
  confirmation_of_acceptance: {
    ...
    confirmation_date: { value: '2026-01-04', enabled: true },
  },
};
...
const bco1 = {
  ...
  header: {
    ...
    date: { value: '2026-01-04', enabled: true },
  },
  offer_reference: {
    ...bcoBase.offer_reference,
    referenced_offer_date: { value: '2026-01-03', enabled: true },
    seller_counter_offer_no: { value: '1', enabled: true },
    address: { value: '123 Main St', enabled: true },
  },
  expiration: {
    ...bcoBase.expiration,
    expiration_date: { value: '2026-01-07', enabled: true },
  },
  section_3_offer: {
    ...bcoBase.section_3_offer,
    offeror_1_signature_date: { value: '2026-01-04', enabled: true },
    offeror_1_typed_name: { value: 'John Buyer', enabled: true },
  },
  section_4_acceptance: {
    ...bcoBase.section_4_acceptance,
    acceptor_1_signature_date: { value: '2026-01-05', enabled: true },
...
const sco2 = {
  ...
  offer_reference: {
    ...
    referenced_offer_date: { value: '2026-01-04', enabled: true },
  ...
  expiration: {
    ...scoBase.expiration,
    expiration_date: { value: '2026-01-08', enabled: true },
  },
  section_4_offer: {
    ...scoBase.section_4_offer,
    offeror_1_signature_date: { value: '2026-01-05', enabled: true },
    offeror_1_typed_name: { value: 'Jane Seller', enabled: true },
  },
  section_5_acceptance: {
    ...scoBase.section_5_acceptance,
    acceptor_1_signature_date: { value: '2026-01-06', enabled: true },
    acceptor_1_typed_name: { value: 'John Buyer', enabled: true },
  },
  confirmation_of_acceptance: {
    ...scoBase.confirmation_of_acceptance,
    confirmation_initials: { value: 'JB', enabled: true },
    confirmation_date: { value: '2026-01-06', enabled: true },
  },
};
...
const bco2 = {
  ...
  header: {
    ...
    date: { value: '2026-01-06', enabled: true },
  },
  offer_reference: {
    ...bcoBase.offer_reference,
    referenced_offer_date: { value: '2026-01-05', enabled: true },
  ...
  expiration: {
    ...bcoBase.expiration,
    expiration_date: { value: '2026-01-09', enabled: true },
  },
  section_3_offer: {
    ...bcoBase.section_3_offer,
    offeror_1_signature_date: { value: '2026-01-06', enabled: true },
    offeror_1_typed_name: { value: 'John Buyer', enabled: true },
  },
  section_4_acceptance: {
    ...bcoBase.section_4_acceptance,
    acceptor_1_signature_date: { value: '2026-01-07', enabled: true },
    acceptor_1_typed_name: { value: 'Jane Seller', enabled: true },
  },
  confirmation_of_acceptance: {
    ...bcoBase.confirmation_of_acceptance,
    confirmation_date: { value: '2026-01-07', enabled: true },
  },
};
...
export const rpaCounterOffer: Scenario = {
  name: 'CA-RPA-counter-offer',
  forms: [
    ...
    { state: 'CA', formCode: 'SCO', data: sco2, label: '2' },
    { state: 'CA', formCode: 'BCO', data: bco2, label: '2' },
  ],
};
