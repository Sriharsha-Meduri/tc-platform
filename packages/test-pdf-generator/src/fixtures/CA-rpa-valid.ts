...
const rpaData = {
  property: {
    datePrepared: { value: '8/8/2026', enabled: true },
    offerFrom: { value: 'Neil Jacob', enabled: true },
    streetAddress: { value: '555 W Imperial Hwy', enabled: true },
    city: { value: 'Brea', enabled: true },
    state: { value: 'CA', enabled: true },
    postalCode: { value: '92821', enabled: true },
    county: { value: 'Orange', enabled: true },
    parcelNo: { value: '6795441', enabled: true },
    apn: { value: '5540-021-015', enabled: true },
  ...
  transaction: {
    ...
    earnestMoneyAmount: { value: 18000, enabled: true },
    section_5c1_percentage: { value: 3.65, enabled: true },
    ...
    closingDate: { value: '6/9/2026', enabled: true },
    closeOfEscrowDate: { value: '6/9/2026', enabled: true },
  ...
  parties: {
    ...
    buyerAgents: [
      {
        fullName: { value: 'Andrew Van', enabled: true },
        email: { value: null, enabled: false },
        phone: { value: null, enabled: false },
        licenseNumber: { value: '1234599', enabled: true },
        companyName: { value: 'Realty', enabled: true },
      },
    ],
    listingAgents: [{
      fullName: { value: 'Robert Gram', enabled: true },
      email: { value: null, enabled: false },
      phone: { value: null, enabled: false },
      licenseNumber: { value: '3467890', enabled: true },
      companyName: { value: 'Realty', enabled: true },
    }],
  ...
  footer: {
    ...
    seller_initial_1: { value: 'NCK', enabled: true },
    seller_initial_2: { value: 'THN', enabled: true },
  },
  page_2: {
    address: { value: '555 W Imperial Hwy', enabled: true },
    ...
    footer_seller_initials_1: { value: 'NCK', enabled: true },
    footer_seller_initials_2: { value: 'THN', enabled: true },
  },
  page_3: {
    address: { value: '555 W Imperial Hwy', enabled: true },
    date: { value: '6/8/2026', enabled: true },
  ...
  page15: {
    ...
    buyerInitial1: { value: 'VCB1', enabled: true },
    buyerInitial2: { value: 'MNB', enabled: true },
    buyerInitial3: { value: 'VCB2', enabled: true },
    buyerInitial4: { value: 'MNB1', enabled: true },
    buyerInitial5: { value: 'VCB3', enabled: true },
    buyerInitial6: { value: 'MNB2', enabled: true },
    sellerInitial1: { value: 'NNB1', enabled: true },
    sellerInitial2: { value: 'ANB', enabled: true },
    sellerInitial3: { value: 'NNB2', enabled: true },
    sellerInitial4: { value: 'NNB3', enabled: true },

    sellerInitial5: { value: 'NNB4', enabled: true },
    sellerInitial6: { value: 'NNB3', enabled: true },
  ...
  page_17: {
    ...
    section_4a_address: { value: '555 W Imperial Hwy', enabled: true },
    section_4a_city: { value: 'Brea', enabled: true },
    section_4a_state: { value: 'CA', enabled: true },
    section_4a_zipcode: { value: '92821', enabled: true },
    ...
    section_4b_address: { value: '555 W Imperial Hwy', enabled: true },
    section_4b_city: { value: 'Brea', enabled: true },
    section_4b_state: { value: 'CA', enabled: true },
    section_4b_zipcode: { value: '92821', enabled: true },
    ...
    footer_seller_initial_1: { value: 'NCK', enabled: true },
    footer_seller_initial_2: { value: 'THN', enabled: true },
  },
};

export const rpaValid: Scenario = {
  name: 'CA-RPA-valid',
  forms: [{ state: 'CA', formCode: 'RPA', data: rpaData }],
};
