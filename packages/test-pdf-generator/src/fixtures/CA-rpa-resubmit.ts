...
const v1 = {
  ...
  page_2: {
    address: { value: '300 Birch St', enabled: true },
  ...
  page_17: {
    ...
    section_4a_address: { value: '300 Birch St', enabled: true },
    ...
    section_4b_address: { value: '300 Birch St', enabled: true },
...
const v2 = {
  ...
  transaction: {
    ...v1.transaction,
    purchasePrice: { value: 875000, enabled: true },
    offerDate: { value: '6/8/2026', enabled: false },
    acceptanceDate: { value: '6/8/2026', enabled: true },
  },
};

export const rpaResubmit: Scenario = {
  name: 'CA-RPA-resubmit',
  forms: [
    { state: 'CA', formCode: 'RPA', data: v1, label: 'V1' },
    { state: 'CA', formCode: 'RPA', data: v2, label: 'V2' },
  ],
};
