...
const ZONE_LABEL = 'the RPA page 12 footer';
const PAGE_LABEL = 'RPA page 12';

const RPA_PAGE_12_SCHEMA = {
  page_number: 12,

  page_validation: {
    is_rpa_page_12:
      '<boolean — true ONLY if the footer identifies the page as "RPA PAGE 12 OF 17">',
    form_revision:
  ...
  execution_review: {
    ...
    full_signatures: {
      full_signature_fields_present_on_page:
        '<boolean — normally false because RPA page 12 contains footer initials only>',
      ...
      signature_review_status:
        '<"not_applicable_on_page_12"|"unexpected_signature_field_detected">',
  ...
  page_12_footer_initials: initialsZoneSchema(ZONE_LABEL),
};
...
SCHEMA:
${JSON.stringify(RPA_PAGE_12_SCHEMA, null, 2)}
`;

export const rpaPage12ExecutionReview: PageDefinition = {
  pageNumber: 12,
  systemPrompt: SYSTEM_PROMPT,
  userPrompt: `
Analyze logical RPA page 12 for missing Buyer and Seller initials.
...
are not required on RPA page 12.
