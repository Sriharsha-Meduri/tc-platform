...
const ZONE_LABEL = 'the RPA page 10 footer';
const PAGE_LABEL = 'RPA page 10';

const RPA_PAGE_10_SCHEMA = {
  page_number: 10,

  page_validation: {
    is_rpa_page_10:
      '<boolean — true ONLY if the footer identifies the page as "RPA PAGE 10 OF 17">',
    form_revision:
  ...
  execution_review: {
    ...
    full_signatures: {
      full_signature_fields_present_on_page:
        '<boolean — normally false because RPA page 10 contains footer initials only>',
      ...
      signature_review_status:
        '<"not_applicable_on_page_10"|"unexpected_signature_field_detected">',
  ...
  page_10_footer_initials: initialsZoneSchema(ZONE_LABEL),
};
...
SCHEMA:
${JSON.stringify(RPA_PAGE_10_SCHEMA, null, 2)}
`;

export const rpaPage10ExecutionReview: PageDefinition = {
  pageNumber: 10,
  systemPrompt: SYSTEM_PROMPT,
  userPrompt: `
Analyze logical RPA page 10 for missing Buyer and Seller initials.
...
are not required on RPA page 10.
